"""
Stub out the FreeCAD/FreeCADGui/Part/Materials/PySide modules that
...
for _name in ("FreeCAD", "FreeCADGui", "Part", "Mesh", "Materials", "PySide", "PySide.QtWidgets", "PySide.QtCore"):
