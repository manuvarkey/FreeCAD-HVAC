...
# fitting TypeId (through_transition_generic / branch_tee_generic /
# branch_wye_generic) can carry several of these, picked per-call from
# the classifier's own flow_class/qualifiers["common_leg"] rather than
